...
<div className="max-w-4xl mx-auto my-8 mt-20 ">
  ...
  {isAuthenticated && 
    <div className="flex justify-center">
      <Link to="/rutas/deportiva/description/:info_id/reservar" className="py-4 px-8 bg-green-500 text-white text-xl font-bold rounded-lg shadow-lg hover:bg-green-600 transition duration-300 ease-in-out">Reservar</Link>
    </div>
  }
</div>
